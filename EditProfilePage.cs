    ...
    public partial class EditProfilePage : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (pas1 == pas2)
            {
                ...
                DashBoard2 dashboardPage = new DashBoard2(Id);
                dashboardPage.Show();
            }
            else
            {
        ...
        private void EditProfilePage_Load(object sender, EventArgs e)
        {
            try
            {
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-QNMJ0BT\\SQLEXPRESS; Initial Catalog=signup;Integrated Security=True");
                con.Open();
                ...
                if (dr.Read())
                {
                    ...
                    textBox4.Text = (dr["term"].ToString());
